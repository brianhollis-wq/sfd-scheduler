 ...
 */
export const CREW_BOARD_COLUMNS = 'apparatus_id, employee_id, position, assignment_type, start_dt, end_dt, employees(first_name, last_name, nickname, rank, badge_number, is_paramedic, shift_assignment)'
